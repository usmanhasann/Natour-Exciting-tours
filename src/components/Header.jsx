    ...
    <>
      ...
      >
        ...
        <div className="absolute top-[40%] left-[50%] translate-x-[-50%] translate-y-[-50%] text-center">
          ...
          <a
            className="bg-white text-center text-[rgb(119,119,119)] py-[15px] btn btn-white btn-animated px-[40px] inline-block uppercase cursor-pointer rounded-[10rem] active:translate-y-[-1px] active:shadow-[0_5px_10px_rgba(0,0,0,0.2)] hover:translate-y-[-3px] hover:shadow-[0_10px_20px_rgba(0,0,0,0.2)]"
            href="#"
          >
            Discover our tours
          </a>
